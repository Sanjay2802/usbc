...
public final class UsbCamera {
    ...
    public enum PIXEL_FORMAT {
        ...
        PIXEL_FORMAT_RGB(0x0B),
        PIXEL_FORMAT_NV21(0x0A),
...
//======================================Java API====================================================
        ...
        if (this.nativeObj != 0) {
            ...
            if (!TextUtils.isEmpty(deviceName)){
                ...
                if (arr.length > 2) {
                    ...
                    Log.e(TAG,"name="+deviceName+", bus="+busNum + ", dev="+devNum);
                }
            }
    ...
    public final synchronized int setSupportInfo(SupportInfo configInfo) {
        int status = STATUS_DESTROYED;
        if (this.nativeObj != 0) {
            status = nativeSetSupportInfo(this.nativeObj, configInfo);
            Logger.d(TAG, "setSupportInfo: " + configInfo.getInfo() + " " + status);
        } else {
